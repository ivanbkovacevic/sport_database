  ...
  //ispisivanje red po red
    ...
    while($row = $result->fetch_assoc()) {
      ...
      $date_upisa = date(
       ...
       $isteklo_uverenje = date('d-M-Y', strtotime($row["datum_pregleda"]."+6 months"));
       $status=uverenje($today,$isteklo_uverenje);
      ...
      <tr>  
        ...
        <td>". $date_pregleda . "</td>
         <td>" .$status. "</td>
        <td>". date('d-M-Y', strtotime($row["datum_pregleda"]."+6 months")). "</td>
