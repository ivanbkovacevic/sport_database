...
$source_page = "user_stranica_trenera.php";
?>
  <?php $page_title = "User stranica trenera"; ?>
  <?php require 'head.php'; ?>
  
  <body>
      <h1>Dobrodošli <?php echo $myusername; ?></h1> 
      <h2><a href = "logout.php">Odjavite se</a></h2>  
...
$where = "AND klub.ime='$myusername' AND pregled.datum_pregleda > '$isteklo7meseci' ";
